...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur Discover Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the Discover Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de Discover',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من Discover',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo Discover',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="Discover" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>
