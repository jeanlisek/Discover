...
// download so a maliciously-named upload cannot run code in the Discover origin.
 ...
 * to download so that an uploaded file cannot run code in the Discover origin.
 *
