const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Skonfiguruj pierwsze konto administratora dla Discover.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w Discover.',
  ...
  'admin.weather.description': 'Discover korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać Discover',

  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja Discover {version}. Używasz {current}.',
  ...
  'admin.update.confirmText': 'Discover zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText': 'Twoja instancja Discover działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'vacay.sharingHint': 'Udostępnij swój plan urlopów innym użytkownikom Discover',
  'vacay.owner': 'Właściciel',
  'vacay.shareEmailPlaceholder': 'E-mail użytkownika Discover',
  ...
  'vacay.inviteHint': 'Zaproś innego użytkownika Discover do wspólnego kalendarza urlopów.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} jest już dostępny.',
  ...
  'notif.version_available.text': 'Discover {version} jest teraz dostępny',
  ...
  'journey.pdf.madeWith': 'Stworzone z Discover',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Witaj w Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malownicze miejsce z interfejsem planowania Discover',
  ...
  'system_notice.v3_photos.body': '**Zdjęcia** w Planerze Podróży zostały usunięte. Twoje zdjęcia są bezpieczne — Discover nigdy nie modyfikował Twojej biblioteki Immich lub Synology.\n\nZdjęcia są teraz dostępne w dodatku **Journey**. Journey jest opcjonalny — jeśli jeszcze nie jest dostępny, poproś administratora o jego włączenie w Admin → Dodatki.',
  ...
  'system_notice.v3_mcp.body': 'Integracja MCP została całkowicie przeprojektowana. OAuth 2.1 jest teraz zalecaną metodą uwierzytelniania. Statyczne tokeny (Discover_…) są przestarzałe i zostaną usunięte w przyszłej wersji.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statyczne tokeny Discover_ przestarzałe',
