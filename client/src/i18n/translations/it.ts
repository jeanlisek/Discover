const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per Discover.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza Discover.',
  ...
  'admin.weather.description': 'Discover utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare Discover',

  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'Discover {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText': 'Discover verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText': 'La tua istanza Discover è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Discover',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': 'Email dell\'utente Discover',
  ...
  'vacay.inviteHint': 'Invita un altro utente Discover a condividere un calendario ferie combinato.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} è ora disponibile.',
  ...
  'notif.version_available.text': 'Discover {version} è ora disponibile',
  ...
  'journey.pdf.madeWith': 'Creato con Discover',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Benvenuto su Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinazione di viaggio panoramica con l\'interfaccia Discover',
  ...
  'system_notice.v3_photos.body': '**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro — Discover non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey è opzionale — se non è ancora disponibile, chiedi al tuo admin di abilitarlo in Admin → Addon.',
  ...
  'system_notice.v3_mcp.body': "L'integrazione MCP è stata completamente rinnovata. OAuth 2.1 è ora il metodo di autenticazione consigliato. I token statici (Discover_\u2026) sono deprecati e verranno rimossi in una versione futura.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statici Discover_ deprecati',
