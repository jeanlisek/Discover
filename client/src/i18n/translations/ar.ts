...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'أعد إعداد أول حساب مسؤول لـ Discover.',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة Discover.',
  ...
  'admin.weather.description': 'يستخدم Discover خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير Discover',

  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'Discover {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث Discover من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل Discover الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  ...
  'vacay.sharingHint': 'شارك خطة إجازاتك مع مستخدمي Discover الآخرين',
  'vacay.owner': 'المالك',
  'vacay.shareEmailPlaceholder': 'البريد الإلكتروني لمستخدم Discover',
  ...
  'vacay.inviteHint': 'ادعُ مستخدم Discover آخرًا لمشاركة تقويم إجازة مشترك.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} متاح الآن.',
  ...
  'notif.version_available.text': 'Discover {version} متاح الآن',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'مرحبًا بك في Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'وجهة سفر خلابة مع واجهة تطبيق Discover',
  ...
  'system_notice.v3_photos.body': 'تمت إزالة تبويب ​**الصور**​ من مخطط الرحلة. صورك آمنة — لم يعدّل Discover مكتبتك على Immich أو Synology قطّ.\n\nتعيش الصور الآن في إضافة **Journey**. Journey اختيارية — إن لم تكن متاحة بعد، اطلب من المسؤول تفعيلها عبر Admin ← الإضافات.',
  ...
  'system_notice.v3_mcp.body': 'تمت إعادة تصميم تكامل MCP بالكامل. OAuth 2.1 هو الآن طريقة المصادقة الموصى بها. الرموز الثابتة (Discover_…) مهملة وستُزال في إصدار مستقبلي.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'الرموز الثابتة Discover_ مهملة',
