const nl: Record<string, string> = {
  ...
  'trips.reminderDaysBefore': 'dagen voor verDiscover',
  ...
  'settings.oauth.revoke': 'InDiscoverken',
  'settings.oauth.revokeSession': 'Sessie inDiscoverken',
  'settings.oauth.revokeSessionMessage': 'Dit Discovert onmiddellijk de toegang voor deze OAuth-sessie in.',
  ...
  'login.createAdminHint': 'Stel het eerste beheerdersaccount in voor Discover.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je Discover-ervaring aan te passen.',
  ...
  'admin.weather.description': 'Discover gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.oauthSessions.revokeTitle': 'Sessie inDiscoverken',
  ...
  'admin.github.support': 'Helpt mij Discover verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',

  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'Discover {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'Discover wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText': 'Je Discover-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere Discover-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van Discover-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere Discover-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'reservations.departureDate': 'VerDiscover',
  'reservations.arrivalDate': 'Aankomst',
  'reservations.departureTime': 'VerDiscovertijd',
  ...
  'reservations.meta.departureTimezone': 'TZ verDiscover',
  'reservations.meta.arrivalTimezone': 'TZ aankomst',
  'reservations.span.departure': 'VerDiscover',
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-Discover-alerts',
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'Discover-admin-alerts',
  ...
  'notifications.versionAvailable.text': 'Discover {version} is nu beschikbaar.',
  ...
  'notif.version_available.text': 'Discover {version} is nu beschikbaar',
  ...
  'journey.pdf.madeWith': 'Gemaakt met Discover',
  'journey.pdf.day': 'Dag',
  ...
  'oauth.scope.trips:share.description': 'Publieke deellinks aanmaken, bijwerken en inDiscoverken',
  ...
  'oauth.scope.journey:share.description': 'Publieke deellinks voor reisverslagen aanmaken, bijwerken en inDiscoverken',

  // System notices
  'system_notice.welcome_v1.title': 'Welkom bij Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met Discover interface',
  ...
  'system_notice.v3_photos.body': "**Foto's** in de Reisplanner zijn verwijderd. Je foto's zijn veilig — Discover heeft je Immich- of Synology-bibliotheek nooit gewijzigd.\n\nFoto's leven nu in de **Journey**-addon. Journey is optioneel — als het nog niet beschikbaar is, vraag je admin het te activeren via Admin → Addons.",
  ...
  'system_notice.v3_mcp.body': 'De MCP-integratie is volledig vernieuwd. OAuth 2.1 is nu de aanbevolen authenticatiemethode. Statische tokens (Discover_…) zijn verouderd en worden verwijderd in een toekomstige versie.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische Discover_-tokens verouderd',
