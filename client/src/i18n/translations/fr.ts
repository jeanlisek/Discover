const fr: Record<string, string> = {
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour Discover.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience Discover.',
  ...
  'admin.weather.description': 'Discover utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de Discover',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',

  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'Discover {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText': 'Discover sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText': 'Votre instance Discover fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs Discover',
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': 'E-mail de l\'utilisateur Discover',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur Discover à partager un calendrier de vacances combiné.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} est maintenant disponible.',
  ...
  'notif.version_available.text': 'Discover {version} est maintenant disponible',
  ...
  'journey.pdf.madeWith': 'Créé avec Discover',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenue sur Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destination de voyage pittoresque avec l\'interface Discover',
  ...
  'system_notice.v3_photos.body': "**Photos** dans le planificateur ont été supprimées. Tes photos sont en sécurité — Discover n'a jamais modifié ta bibliothèque Immich ou Synology.\n\nLes photos vivent désormais dans l'addon **Journey**. Journey est optionnel — s'il n'est pas encore disponible, demande à ton admin de l'activer dans Admin → Modules.",
  ...
  'system_notice.v3_mcp.body': "L'intégration MCP a été entièrement repensée. OAuth 2.1 est désormais la méthode d'authentification recommandée. Les tokens statiques (Discover_\u2026) sont dépréciés et seront supprimés dans une future version.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens statiques Discover_ dépréciés',
