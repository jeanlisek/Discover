const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro Discover.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si Discover.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj Discover',

  // Počasí (Weather)
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description': 'Discover používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'Discover {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText': 'Discover bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText': 'Váš Discover běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli Discover',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele Discover',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele Discover ke sdílení společného kalendáře dovolených.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} je nyní k dispozici.',
  ...
  'notif.version_available.text': 'Discover {version} je nyní dostupný',
  ...
  'journey.pdf.madeWith': 'Vytvořeno pomocí Discover',
  'journey.pdf.day': 'Den',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Vítejte v Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním Discover',
  ...
  'system_notice.v3_photos.body': '**Fotografie** v Plánovacím nástroji byly odebrány. Vaše fotografie jsou v bezpečí — Discover nikdy neupravoval vaši knihovnu Immich nebo Synology.\n\nFotografie jsou nyní dostupné v doplňku **Journey**. Journey je volitelný — pokud ještě není k dispozici, požádejte svého správce, aby ho aktivoval v Admin → Doplňky.',
  ...
  'system_notice.v3_mcp.body': 'Integrace MCP byla kompletně přepracována. OAuth 2.1 je nyní doporučenou metodou ověřování. Statické tokeny (Discover_…) jsou zastaralé a budou v budoucí verzi odstraněny.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statické tokeny Discover_ zastaralé',
