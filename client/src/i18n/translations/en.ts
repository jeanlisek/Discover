const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Set up the first admin account for Discover.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Discover experience.',
  ...
  'admin.weather.description': 'Discover uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Discover',

  'admin.update.available': 'Update available',
  'admin.update.text': 'Discover {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText': 'Discover will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText': 'Your Discover instance runs in Docker. To update to {version}, run the following commands on your server:',
  ...
  'vacay.sharingHint': 'Share your vacation plan with other Discover users',
  'vacay.owner': 'Owner',
  'vacay.shareEmailPlaceholder': 'Email of Discover user',
  ...
  'vacay.inviteHint': 'Invite another Discover user to share a combined vacation calendar.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} is now available.',
  ...
  'notif.version_available.text': 'Discover {version} is now available',
  ...
  'journey.pdf.madeWith': 'Made with Discover',
  'journey.pdf.day': 'Day',
  ...
  'system_notice.v3_photos.body': '**Photos** in the Trip Planner have been removed. Your photos are safe — Discover never modified your Immich or Synology library.\n\nPhotos now live in the **Journey** addon. Journey is optional — if it is not yet available, ask your admin to enable it under Admin → Addons.',
  ...
  'system_notice.v3_mcp.body': 'The MCP integration has been fully overhauled. OAuth 2.1 is now the recommended auth method. Legacy static tokens (Discover_\u2026) are deprecated and will be removed in a future release.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Static Discover_ tokens deprecated',
  ...
  'system_notice.welcome_v1.title': 'Welcome to Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with Discover planning UI overlay',
