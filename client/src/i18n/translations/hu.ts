const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Hozd létre az első admin fiókot a Discover-hez.',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a Discover testreszabásához.',
  ...
  'admin.weather.description': 'A Discover az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a Discover fejlesztését',

  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A Discover {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText': 'A Discover frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText': 'A Discover példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'vacay.sharingHint': 'Szabadságterved megosztása más Discover felhasználókkal',
  'vacay.owner': 'Tulajdonos',
  'vacay.shareEmailPlaceholder': 'Discover felhasználó e-mail címe',
  ...
  'vacay.inviteHint': 'Hívj meg egy másik Discover felhasználót közös szabadságnaptár megosztásához.',
  ...
  'notifications.versionAvailable.text': 'A Discover {version} már elérhető.',
  ...
  'notif.version_available.text': 'A Discover {version} elérhető',
  ...
  'journey.pdf.madeWith': 'Készítve a Discover segítségével',
  'journey.pdf.day': 'Nap',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Üdvözöl a Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Festői úticél Discover tervező felülettel',
  ...
  'system_notice.v3_photos.body': 'Az útiterv-tervező **Fényképek** lapja eltávolításra került. Fényképeid biztonságban vannak — Discover soha nem módosította Immich vagy Synology könyvtáradat.\n\nA fényképek mostantól a **Journey** bővítményben élnek. A Journey opcionális — ha még nem elérhető, kérd meg a rendszergazdát, hogy engedélyezze Admin → Bővítmények alatt.',
  ...
  'system_notice.v3_mcp.body': 'Az MCP integráció teljesen megújult. Az OAuth 2.1 mostantól az ajánlott hitelesítési módszer. A statikus tokenek (Discover_…) elavultak és egy jövőbeli kiadásban eltávolításra kerülnek.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statikus Discover_ tokenek elavultak',
