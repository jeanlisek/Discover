const es: Record<string, string> = {
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de Discover.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en Discover.',
  ...
  'admin.weather.description': 'Discover utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando Discover',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'Discover {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText': 'Discover se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText': 'Tu instancia de Discover se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de Discover',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo electrónico del usuario de Discover',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de Discover a compartir un calendario combinado de vacaciones.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} ya está disponible.',
  ...
  'notif.version_available.text': 'Discover {version} ya está disponible',
  ...
  'journey.pdf.madeWith': 'Hecho con Discover',
  'journey.pdf.day': 'Día',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenido a Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de Discover',
  ...
  'system_notice.v3_photos.body': '**Fotos** en el Planificador de Viajes han sido eliminadas. Tus fotos están a salvo — Discover nunca modificó tu biblioteca de Immich o Synology.\n\nLas fotos ahora viven en el addon **Journey**. Journey es opcional — si aún no está disponible, pide a tu admin que lo active en Admin → Complementos.',
  ...
  'system_notice.v3_mcp.body': 'La integración MCP ha sido completamente renovada. OAuth 2.1 es ahora el método de autenticación recomendado. Los tokens estáticos (Discover_…) están obsoletos y se eliminarán en una versión futura.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos Discover_ obsoletos',
