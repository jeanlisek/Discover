const zh: Record<string, string> = {
  ...
  'login.createAdminHint': '为 Discover 设置第一个管理员账户。',
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 Discover 体验。',
  ...
  'admin.weather.description': 'Discover 使用 Open-Meteo 作为天气数据源。Open-Meteo 是免费的开源天气服务——无需 API 密钥。',
  ...
  'admin.github.support': '帮助我继续开发 Discover',
  'admin.github.error': '加载版本失败',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'Discover {version} 已发布。你当前使用的是 {current}。',
  'admin.update.button': '在 GitHub 查看',
  'admin.update.install': '安装更新',
  'admin.update.confirmTitle': '确定安装更新？',
  'admin.update.confirmText': 'Discover 将从 {current} 更新到 {version}。服务器将自动重启。',
  ...
  'admin.update.dockerText': '你的 Discover 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 Discover 用户共享你的假期计划',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Discover 用户邮箱',
  ...
  'vacay.inviteHint': '邀请其他 Discover 用户共享合并的假期日历。',
  ...
  'notifications.versionAvailable.text': 'Discover {version} 现已可用。',
  ...
  'notif.version_available.text': 'Discover {version} 现已可用',
  ...
  'journey.pdf.madeWith': '由 Discover 制作',
  'journey.pdf.day': '第',
  ...
  'system_notice.v3_photos.body': '行程规划器中的​**照片**标签已被移除。您的照片安全无虑 — Discover 从未修改您的 Immich 或 Synology 相册。\n\n照片现在位于 **Journey** 插件中。Journey 是可选的 — 如果尚未启用，请联系管理员在 Admin → 插件 中开启。',
  ...
  'system_notice.v3_mcp.body': 'MCP 集成已全面重构。OAuth 2.1 现为推荐的身份验证方式。静态令牌（Discover_…）已弃用，将在未来版本中移除。',
  'system_notice.v3_mcp.highlight_oauth':      'OAuth 2.1 推荐（mcp-remote）',
  'system_notice.v3_mcp.highlight_scopes':     '24 个细粒度权限范围',
  'system_notice.v3_mcp.highlight_deprecated': '静态 Discover_ 令牌已弃用',
