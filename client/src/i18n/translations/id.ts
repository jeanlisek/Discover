const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Siapkan akun admin pertama untuk Discover.',
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman Discover kamu.',
  ...
  'admin.weather.description': 'Discover menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan Discover',

  'admin.update.available': 'Pembaruan tersedia',
  'admin.update.text': 'Discover {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText': 'Discover akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText': 'Instans Discover kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna Discover lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna Discover',
  ...
  'vacay.inviteHint': 'Undang pengguna Discover lain untuk berbagi kalender cuti bersama.',
  ...
  'places.gpxImportTracks': 'Discover (dengan geometri jalur)',
  ...
  'notifications.versionAvailable.text': 'Discover {version} kini tersedia.',
  ...
  'notif.version_available.text': 'Discover {version} kini tersedia',
  ...
  'journey.pdf.madeWith': 'Dibuat dengan Discover',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Selamat datang di Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka Discover',
  ...
  'system_notice.v3_photos.body': '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — Discover tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.',
  ...
  'system_notice.v3_mcp.body': 'Integrasi MCP telah sepenuhnya diperbarui. OAuth 2.1 kini menjadi metode autentikasi yang direkomendasikan. Token statis (Discover_…) sudah usang dan akan dihapus pada versi mendatang.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statis Discover_ sudah usang',
