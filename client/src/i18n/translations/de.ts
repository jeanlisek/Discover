const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für Discover.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um Discover nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description': 'Discover nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, Discover weiterzuentwickeln',

  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'Discover {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText': 'Discover wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText': 'Deine Discover-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.sharingHint': 'Teile deinen Urlaubsplan mit anderen Discover-Benutzern',
  'vacay.owner': 'Besitzer',
  'vacay.shareEmailPlaceholder': 'E-Mail des Discover-Benutzers',
  ...
  'vacay.inviteHint': 'Lade einen anderen Discover-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} ist jetzt verfügbar.',
  ...
  'notif.version_available.text': 'Discover {version} ist jetzt verfügbar',
  ...
  'journey.pdf.madeWith': 'Erstellt mit Discover',
  'journey.pdf.day': 'Tag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Willkommen bei Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit Discover-Planungs-UI',
  ...
  'system_notice.v3_photos.body': '**Fotos** im Trip-Planer wurden entfernt. Deine Fotos sind sicher — Discover hat deine Immich- oder Synology-Bibliothek nie verändert.\n\nFotos befinden sich jetzt im **Journey**-Addon. Journey ist optional — falls es noch nicht verfügbar ist, bitte deinen Admin, es unter Admin → Addons zu aktivieren.',
  ...
  'system_notice.v3_mcp.body': 'Die MCP-Integration wurde vollständig überarbeitet. OAuth 2.1 ist jetzt die empfohlene Authentifizierungsmethode. Statische Tokens (Discover_…) sind veraltet und werden in einer zukünftigen Version entfernt.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische Discover_-Tokens veraltet',
