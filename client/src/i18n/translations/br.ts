const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'login.createAdminHint': 'Configure a primeira conta de administrador do Discover.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no Discover.',
  ...
  'admin.weather.description': 'O Discover usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o Discover',

  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O Discover {version} está disponível. Você está na {current}.',
  'admin.update.button': 'Ver no GitHub',
  'admin.update.install': 'Instalar atualização',
  'admin.update.confirmTitle': 'Instalar atualização?',
  'admin.update.confirmText': 'O Discover será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância Discover roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do Discover',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário Discover',
  ...
  'vacay.inviteHint': 'Convide outro usuário Discover para compartilhar um calendário de férias combinado.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} já está disponível.',
  ...
  'notif.version_available.text': 'Discover {version} está disponível',
  ...
  'journey.pdf.madeWith': 'Feito com Discover',
  'journey.pdf.day': 'Dia',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bem-vindo ao Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viagem pitoresco com a interface do Discover',
  ...
  'system_notice.v3_photos.body': '**Fotos** no Planejador de Viagens foram removidas. Suas fotos estão seguras — o Discover nunca modificou sua biblioteca Immich ou Synology.\n\nAs fotos agora vivem no addon **Journey**. Journey é opcional — se ainda não estiver disponível, peça ao seu admin para ativá-lo em Admin → Addons.',
  ...
  'system_notice.v3_mcp.body': 'A integração MCP foi completamente reformulada. OAuth 2.1 agora é o método de autenticação recomendado. Tokens estáticos (Discover_…) foram descontinuados e serão removidos em uma versão futura.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos Discover_ descontinuados',
