const zhTw: Record<string, string> = {
  ...
  'login.createAdminHint': '為 Discover 設定第一個管理員賬戶。',
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 Discover 體驗。',
  ...
  'admin.weather.description': 'Discover 使用 Open-Meteo 作為天氣資料來源。Open-Meteo 是免費的開源天氣服務——無需 API 金鑰。',
  ...
  'admin.github.support': '幫助我繼續開發 Discover',
  'admin.github.error': '載入版本失敗',
  'admin.github.by': '作者',

  'admin.update.available': '有可用更新',
  'admin.update.text': 'Discover {version} 已釋出。你當前使用的是 {current}。',
  'admin.update.button': '在 GitHub 檢視',
  'admin.update.install': '安裝更新',
  'admin.update.confirmTitle': '確定安裝更新？',
  'admin.update.confirmText': 'Discover 將從 {current} 更新到 {version}。伺服器將自動重啟。',
  ...
  'admin.update.dockerText': '你的 Discover 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '與其他 Discover 使用者共享你的假期計劃',
  'vacay.owner': '所有者',
  'vacay.shareEmailPlaceholder': 'Discover 使用者郵箱',
  ...
  'vacay.inviteHint': '邀請其他 Discover 使用者共享合併的假期日曆。',
  ...
  'journey.pdf.madeWith': '由 Discover 製作',
  'journey.pdf.day': '第',
  ...
  'notifications.versionAvailable.text': 'Discover {version} 現已推出。',
  ...
  'notif.version_available.text': 'Discover {version} 現已推出',
  ...
  'system_notice.v3_photos.body': '行程規劃器中的​**相片**標籤已被移除。您的相片安全— Discover 從未修改您的 Immich 或 Synology 相簿。\n\n相片現在位於 **Journey** 附加元件中。Journey 為選用 — 若尚未啟用，請聯絡管理員於 Admin → 附加元件 中開啟。',
  ...
  'system_notice.v3_mcp.body': 'MCP 整合已全面重構。OAuth 2.1 現為建議的身份驗證方式。靜態令牌（Discover_…）已棄用，將於未來版本移除。',
  'system_notice.v3_mcp.highlight_oauth':      'OAuth 2.1 建議（mcp-remote）',
  'system_notice.v3_mcp.highlight_scopes':     '24 個細粒度權限範圍',
  'system_notice.v3_mcp.highlight_deprecated': '靜態 Discover_ 令牌已棄用',
