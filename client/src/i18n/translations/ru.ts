const ru: Record<string, string> = {
  ...
  'login.createAdminHint': 'Настройте первый аккаунт администратора для Discover.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки Discover под себя.',
  ...
  'admin.weather.description': 'Discover использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку Discover',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',

  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия Discover {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'Discover будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр Discover работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями Discover',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя Discover',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя Discover для совместного календаря отпусков.',
  ...
  'notifications.versionAvailable.text': 'Discover {version} теперь доступен.',
  ...
  'notif.version_available.text': 'Discover {version} теперь доступен',
  ...
  'journey.pdf.madeWith': 'Сделано с помощью Discover',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Добро пожаловать в Discover',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом Discover',
  ...
  'system_notice.v3_photos.body': 'Вкладка **Фото** в Планировщике путешествий удалена. Ваши фото в безопасности — Discover никогда не изменял вашу библиотеку Immich или Synology.\n\nФото теперь доступны в дополнении **Journey**. Journey необязателен — если он ещё недоступен, попросите администратора включить его в разделе Admin → Дополнения.',
  ...
  'system_notice.v3_mcp.body': 'Интеграция MCP была полностью переработана. OAuth 2.1 теперь является рекомендуемым методом аутентификации. Статические токены (Discover_…) устарели и будут удалены в будущей версии.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Статические токены Discover_ устарели',
