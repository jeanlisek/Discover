...
The **GitHub** tab shows the Discover release history fetched from GitHub and provides links to community resources and support options.
...
| **Discord** | Join the Discover community |
