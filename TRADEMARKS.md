...
This is the Discover project's policy for the use of our trademarks. While Discover is
...
be full participants in the Discover project.

## Our trademarks

This policy covers the name "Discover" as well as any associated logos, trade dress,
...
say you are distributing Discover when you're distributing a modified version of it,
...
your website in a way that suggests that your website is an official Discover
website or that we endorse your website. But, if true, you can say you like
Discover, that you participate in the Discover community, that you are providing an
unmodified version of Discover, or that you wrote a guide describing how to use
Discover.
...
When you redistribute an unmodified copy of Discover, you are not changing the
...
you are redistributing an official Discover distribution that has not been changed
in any way.

## Distribution of executable code that you have compiled, or modified code

You may use the word mark "Discover", but not any Discover logos, to truthfully
describe the origin of the software that you are providing, that is, that the
code you are distributing is a modification of Discover. You may say, for example,
that "this software is derived from the source code for Discover."
...
executable) on the condition that any executable is built from an official Discover
...
The following clarifications apply specifically to common ways Discover is
redistributed:

* **Self-hosted instances of unmodified Discover.** You may refer to your instance
  as "a Discover instance" or "running Discover." You may not name the service itself
  in a way that suggests it is the official Discover ("Discover Cloud," "Discover
  Official," etc.).
* **Mobile wrappers (WebView shells, Capacitor apps, native apps) pointing at
  Discover.** You may describe your app as "a mobile client for Discover" or "for use
  with Discover." You may not publish it on app stores under the name "Discover" or a
  confusingly similar name, and you may not use the Discover logo as the app icon
  unless your wrapper distributes only an unmodified, official Discover instance
  and you have obtained permission.
* **Forks of the Discover source code.** Forks that diverge from upstream must use
  a different name. You may state that your fork is "based on Discover" or "a fork
  of Discover," but the project name itself must be your own.

## Statements about your software's relation to Discover

You may use the word mark, but not Discover logos, to truthfully describe the
relationship between your software and ours. The word mark "Discover" should be
used after a verb or preposition that describes the relationship between your
software and ours. So you may say, for example, "Bob's app for Discover" but may
not say "Bob's Discover app." Some other examples that may work for you are:

* [Your software] uses Discover
* [Your software] is powered by Discover
* [Your software] runs on Discover
* [Your software] for use with Discover
* [Your software] for Discover
...
is not covered, please open an issue on the Discover GitHub repository or contact
